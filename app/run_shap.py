...
print("Loading data...")
df = pd.read_csv(os.path.join(BASE_DIR, "data", "cleaned_dataset_for_ml.csv"))
...
plt.tight_layout()
plt.savefig(os.path.join(BASE_DIR, "plots", "shap_summary.png"), bbox_inches='tight', dpi=300)
plt.close()
...
feature_importance.to_csv(os.path.join(BASE_DIR, "plots", "shap_importance.csv"), index=False)
